...
/**
 * HandlerMethodArgumentResolver 조건에 맞는 메소드가 있다면 HandlerMethodArgumentResolver
...
public class LoginUserArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public boolean supportsParameter(MethodParameter parameter) {
        boolean isLoginUserAnnotation = !Objects.isNull(parameter.getParameterAnnotation(LoginUser.class));
